<script>
    ...
    import Uploading from "$lib/components/files/Uploading.svelte";
    import {
        Upload,
        FolderPlus,
        Check,
                        ...
                        >
                            ...
                            >
                                <audio
                                    controls
                                    class="w-full"
                                    src={`/api/download?file=${encodeURIComponent([...currentPath, selectedFile.name].join("/"))}`}
                                    on:load={() => (loadingPreview = false)}
                                >
...
<Uploading uploading={uploading} totalUploadProgress={totalUploadProgress} uploadProgress={uploadProgress} />
